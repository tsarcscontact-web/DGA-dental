...
const showInfo = () => {
  ...
  setTimeout(() => {
    ytButton.setAttribute("visible", true);
  }, 1200);

  setTimeout(() => {
    ttButton.setAttribute("visible", true);
  }, 1500);

  webButton.addEventListener('click', () => window.location.href = "https://www.instagram.com/digidentglobalacademy/#");
  emailButton.addEventListener('click', () => window.location.href = "tel:1-(205)-809-0821");
  profileButton.addEventListener('click', () => window.location.href = "https://dgadental.com/");
  locationButton.addEventListener('click', () => window.location.href = "mailto:support@dgadental.com");
  ytButton.addEventListener('click', () => window.location.href = "https://www.facebook.com/profile.php?id=61571532702980");
  ttButton.addEventListener('click', () => window.location.href = "https://www.linkedin.com/company/digident-global-academy/");
}
...
saveBtn.addEventListener('click', () => {
  const imagePath = "./assets/logo (1).png"; // <-- put your file path or URL here
...
N:DGA;Dental;;;
FN:DGA Dental
TEL;TYPE=CELL:1-(205)-809-0821
TEL;TYPE=WHATSAPP:+1 302-663-7677
EMAIL:support@dgadental.com
